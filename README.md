...
```bash
$ oc create -f https://raw.githubusercontent.com/BabbarPB08/pipelines-tutorial/master/01_pipeline/01_apply_manifest_task.yaml

$ oc create -f https://raw.githubusercontent.com/BabbarPB08/pipelines-tutorial/master/01_pipeline/02_update_deployment_task.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/BabbarPB08/pipelines-tutorial/master/01_pipeline/04_pipeline.yaml
```
...
$ tkn pipeline start build-and-deploy \
    -w name=shared-workspace,volumeClaimTemplateFile=https://raw.githubusercontent.com/BabbarPB08/pipelines-tutorial/master/01_pipeline/03_persistent_volume_claim.yaml \
...
```bash
$ oc create -f https://raw.githubusercontent.com/BabbarPB08/pipelines-tutorial/master/03_triggers/02_template.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/BabbarPB08/pipelines-tutorial/master/03_triggers/01_binding.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/BabbarPB08/pipelines-tutorial/master/03_triggers/03_trigger.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/BabbarPB08/pipelines-tutorial/master/03_triggers/04_event_listener.yaml
```
